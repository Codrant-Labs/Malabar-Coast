...
export function HallEnquiryForm() {
  ...
  return <form className={styles.form} onSubmit={submit}>
    <div className={styles.grid}>
      ...
      <label>Preferred date<SmartDateInput name="preferredDate" min={minimumDate} required /></label><label>Alternative date<SmartDateInput name="alternativeDate" min={minimumDate} /></label>
